...
export function Sidebar() {
  ...
  return (
    <aside className="w-[240px] bg-black border-r border-white/10 flex flex-col justify-between py-5 min-h-[calc(100vh-61px)]">
      {/* Navigation */}
      <nav className="px-3 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon className={`w-[17px] h-[17px] ${isActive ? 'text-gcore-orange' : 'text-neutral-500'}`} strokeWidth={1.8} />
              <span>{item.name}</span>
            </Link>
          );
        })}
      ...
      <div className="mx-3 mt-6">
        <div className="gcore-card rounded-apple-xl p-3.5 text-xs space-y-2.5 border border-white/10 bg-[#080808]">
          ...
          <ul className="space-y-1.5 text-neutral-400 font-mono text-[11px]">
            <li className="flex justify-between">
              <span className="text-neutral-500">VAD</span>
              <span className="text-neutral-200 font-medium">Silero Neural</span>
            </li>
            <li className="flex justify-between">
              <span className="text-neutral-500">STT</span>
              <span className="text-neutral-200 font-medium">Deepgram Nova-2</span>
            </li>
            <li className="flex justify-between">
            ...
            <li className="flex justify-between">
              ...
              <span className="text-neutral-200 font-medium">Cartesia Sonic</span>
            </li>
